---
title: "JavaScript 插件上下文和类型"
description: "理解 autClaw JavaScript 插件的 Sender 运行上下文、senderID、返回包装、SendReceipt 和媒体类型。"
keywords: ["Sender 上下文", "senderID", "SendReceipt", "MediaItem"]
icon: "circle-dot"
---
