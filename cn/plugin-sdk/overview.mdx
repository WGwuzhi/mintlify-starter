---
title: "autClaw 插件 SDK 概览"
description: "了解 autClaw 插件 SDK，选择 JavaScript 或 Python 编写普通插件，读取消息、发送回复和保存状态。"
keywords: ["autClaw 插件 SDK", "JavaScript 插件", "Python 插件", "Sender"]
icon: "puzzle"
---
...
<CardGroup cols={2}>
  ...
  <Card title="适配器开发" icon="plug" href="/cn/plugin-sdk/adapter">
    接入新 IM 渠道：了解接入形态与能力声明，选择 Go 或 Node.js 实现。
  </Card>
