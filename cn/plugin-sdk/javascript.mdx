---
title: "autClaw JavaScript 插件参考"
description: "查看 autClaw JavaScript 插件 middleware.js 的入口、Sender 用法、消息回复、存储、路由和定时任务。"
keywords: ["middleware.js", "JavaScript 中间件", "Sender", "autClaw 插件开发"]
icon: "braces"
---
