...
pushImage("qq", "123456", "", "日报", "./daily.png", {"account_id": "bot_qq_ops"})
pushVideo("qq", "123456", "", "演示视频", "./demo.mp4", {"account_id": "bot_qq_ops"})
...
更多主动推送账号选择规则见 [`JavaScript 主动推送`](/cn/plugin-sdk/javascript/push) 或 [`Python 主动推送`](/cn/plugin-sdk/python/push)。
