...
- JSON Schema：[`schemas/plugin-manifest.schema.json`](https://ac-d39c0861.mintlify.app/cn/plugin-sdk/schemas/plugin-manifest.schema.json)
- JavaScript 类型声明：[`types/middleware-js.d.ts`](https://ac-d39c0861.mintlify.app/cn/plugin-sdk/types/middleware-js.d.ts)
