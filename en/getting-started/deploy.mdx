...
description: "Deploy autClaw with Docker bridge networking on Linux, FNOS, or Synology DSM, including the 8200 port mapping and persistent storage."
keywords: ["autClaw deployment", "Docker deploy autClaw", "Docker bridge", "FNOS", "Synology DSM"]
icon: "rocket"
---

This guide shows how to deploy autClaw with the official Docker image. You will configure the `8200` port, persistent storage, and common NAS paths so plugins and data survive upgrades or container recreation.
