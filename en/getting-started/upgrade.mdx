...
description: "Upgrade autClaw from the web console or an IM administrator command, and confirm which runtime directories and middleware files are preserved."
