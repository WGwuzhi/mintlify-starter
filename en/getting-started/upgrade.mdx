---
title: "How to upgrade autClaw"
description: "Upgrade autClaw from the web app or an IM administrator command, and confirm which runtime directories and middleware files are preserved."
keywords: ["autClaw upgrade", "online update", "IM update command", "middleware", "Docker upgrade"]
icon: "refresh-cw"
---

This page explains how to upgrade the autClaw application version and which files can be overwritten during online updates, first-run bundle downloads, or release bundle updates. For daily upgrades, prefer the web console or an administrator IM command.
