...
description: "Use JavaScript push, pushImage, and pushMixed to proactively send text, media, and mixed messages while controlling the sending account."
keywords: ["proactive push", "pushMixed", "pushImage", "account_id"]
icon: "send"
---
