---
title: "JavaScript wait for input and payment"
description: "Use listen, input, and waitPay in JavaScript plugins to wait for user input, capture media, and handle payment amount matching."
keywords: ["listen", "input", "waitPay", "payment matching"]
icon: "hourglass"
---
