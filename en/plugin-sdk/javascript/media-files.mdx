---
title: "JavaScript events, media, and files"
description: "Read event data, get media items, download user-uploaded files, and fetch group member lists in JavaScript plugins."
