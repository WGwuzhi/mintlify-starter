...
description: "Declare autClaw plugin manifest headers such as author, runtime, rule, param, dependency, router, and cron at the top of a plugin file."
keywords: ["plugin manifest", "manifest headers", "rule", "param", "cron"]
icon: "file-code"
---
