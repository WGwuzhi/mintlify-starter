---
title: "autClaw plugin SDK overview"
description: "Learn the autClaw plugin SDK, choose JavaScript or Python for regular plugins, read messages, send replies, and store state."
keywords: ["autClaw plugin SDK", "JavaScript plugin", "Python plugin", "Sender"]
icon: "puzzle"
---
