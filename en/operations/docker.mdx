...
description: "Use Docker and Docker Compose to view autClaw logs, restart, remove, and update the container on Linux, FNOS, or Synology DSM."
keywords: ["autClaw Docker", "Docker Compose", "view logs", "update container", "FNOS Docker"]
icon: "container"
---

Use this page for daily container maintenance after autClaw is deployed. You can view logs, recreate the container, pull the latest image, or manage FNOS and Synology DSM persistent directories with Docker Compose.
