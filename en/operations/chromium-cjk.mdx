---
title: "Configure Chromium CJK support for autClaw"
description: "Install Chromium, Chinese fonts, and locale on Debian or Ubuntu when running autClaw release artifacts directly for screenshots and browser scripts."
keywords: ["Chromium Chinese fonts", "CJK locale", "autClaw screenshots", "browser scripts", "Debian Chromium"]
icon: "languages"
---
...
The Docker image already includes the common runtime environment. Use this page only when you run autClaw directly on the host and screenshots, browser scripts, or rendered pages show missing Chinese glyphs or mojibake.
...
If the commands do not show the Chinese locale or a CJK font, rerun the install command and confirm that `locale-gen zh_CN.UTF-8` completed successfully.
